...
namespace Services
{
    class UserService : Singleton<UserService>, IDisposable
    {
        ...
        public void SendCharacterCreate(string charName, CharacterClass cla)
        {
            Debug.LogFormat("SendCharacterCreate::charName :{0} Class:{1}", charName, cla);
            NetMessage message = new NetMessage();
            message.Request = new NetMessageRequest();
            message.Request.createChar = new UserCreateCharacterRequest();
            message.Request.createChar.Name = charName;
            message.Request.createChar.Class = cla;
        ...
        public void SendGameEnter(int characteridx)
        {
            ...
            ChatManager.Instance.Init();//进入游戏前初始化聊天系统
