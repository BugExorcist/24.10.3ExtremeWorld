...
namespace Services
{
    class FriendService : Singleton<FriendService> , IDisposable
    {
        ...
        public FriendService()
        {
            ...
            MessageDistributer.Instance.Subscribe<FriendAddResponse>(this.OnFriendAddResponce);
        ...
        public void Dispose()
        {
            ...
            MessageDistributer.Instance.Unsubscribe<FriendAddResponse>(this.OnFriendAddResponce);
        ...
        public void SendFriendAddResponse(bool accept, FriendAddRequest request)
        {
            ...
            message.Request.friendAddRes.Errormsg = accept ? "对方同意" : "对方拒绝了你的好友申请";
        ...
        private void OnFriendAddResponce(object sender, FriendAddResponse message)
        {
            if (message.Result == Result.Success)
                MessageBox.Show("添加好友成功", "提示");
            else
                MessageBox.Show("添加好友失败 " + message.Errormsg, "提示");
        }
